...
const store = {
  smartSkin: localStorage.getItem('ti-skin') || config.tiSkin,
  skin: config.skins.find((_skin) => {
    return _skin.name == (localStorage.getItem('ti-skin') || config.tiSkin);
  }),
  skins: config.skins,
  fixedHeader: localStorage.getItem('ti-fixed-header') == 'true',
  fixedNavigation: localStorage.getItem('ti-fixed-navigation') == 'true',
...
// constructor(private notificationService: NotificationService) {
  ...
  */
  ...
  dumpStorage() {
    localStorage.setItem('ti-skin', this.store.smartSkin);
    localStorage.setItem('ti-fixed-header', this.store.fixedHeader);
    localStorage.setItem('ti-fixed-navigation', this.store.fixedNavigation);
    localStorage.setItem('ti-fixed-ribbon', this.store.fixedRibbon);
    localStorage.setItem('ti-fixed-page-footer', this.store.fixedPageFooter);
    localStorage.setItem('ti-inside-container', this.store.insideContainer);
    localStorage.setItem('ti-rtl', this.store.rtl);
    localStorage.setItem('ti-menu-on-top', this.store.menuOnTop);
    localStorage.setItem('ti-colorblind-friendly', this.store.colorblindFriendly);
  }
